 ...
 *                      <li>order: for when a customer has placed an order.</li>
 *                      <li>video: for video (media) messages.</li>
 *                      <li>button: for responses to interactive message templates.</li>
 *                      <li>contacts: for contact messages.</li>
 ...
 *                    <li>A user clicks on an ad with the Click to WhatsApp call-to-action.</li>
 *                    <li>User is redirected to WhatsApp and sends a message to the advertising business.</li>
 *                    <li>User sends a message to the business. Be aware that users may elect to remove their referral data.</li>
 *                    <li>The advertising business gets an inbound message notification including the referral object, which provides additional context on the ad that triggered the message. Knowing all this information, the business can appropriately reply to the user message.</li></ul>
