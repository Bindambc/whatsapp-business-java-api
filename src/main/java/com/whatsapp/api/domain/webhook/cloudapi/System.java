 ...
 * @param type    Supported types are: <ul>
 *                <li>user_changed_number: for a user changed number notification.</li>
 *                <li>user_identity_changed: for user identity changed notification.</li>
 *                </ul>
 */
